...
for (ct in leonie_cell_types){
  ...
  for (cond in condition_list){
    ...
    print(EnhancedVolcano(tt_tmp, lab = rownames(tt_tmp), x = 'logFC', y = 'PValue',
                          title = paste("Vulcano plot for ", ct_print, " (",cont_tmp, ")", sep = "")))
    ggsave(
